package nl.fullbrainpicture.structures;
...
public class BinaryHeap1D {
	...
	public BinaryHeap1D(int Nsize, int type) {
		currentSize = 0;
		capacity = Nsize;
		minormax = type;
	...
	public BinaryHeap1D(int Nsize, int Nincrease, int type) {
		currentSize = 0;
		capacity = Nsize;
		minormax = type;
		val = new float[capacity+1];
	 ...
	 */
	public final void addValue(float val_, int id_) {
		// check for size
